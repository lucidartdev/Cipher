...
export default function CipherLanding() {
  ...
  <div className="grid md:grid-cols-3 gap-8">
    {/* Card 1 */}
    <div className="group h-[45vh] bg-white/20 backdrop-blur-2xl border border-white/30 rounded-3xl p-8 shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] hover:bg-[#023697]/10 hover:border-[#023697]/40 transition-all duration-500 hover:scale-105 cursor-pointer flex flex-col items-center justify-center text-center">
      <div className="mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
        <img src="/assets/image/Gas.png" alt="Gas Tracking" className="w-24 h-24 object-contain" />
      </div>
    ...
    <div className="group h-[45vh] bg-white/20 backdrop-blur-2xl border border-white/30 rounded-3xl p-8 shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] hover:bg-[#023697]/10 hover:border-[#023697]/40 transition-all duration-500 hover:scale-105 cursor-pointer flex flex-col items-center justify-center text-center">
      <div className="mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
        <img src="/assets/image/warning.png" alt="Risk Detection" className="w-24 h-24 object-contain" />
      </div>
      <h3 className="text-2xl font-bold mb-3 text-gray-900">
        Risk Detection
      </h3>
    ...
    <div className="group h-[45vh] bg-white/20 backdrop-blur-2xl border border-white/30 rounded-3xl p-8 shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] hover:bg-[#023697]/10 hover:border-[#023697]/40 transition-all duration-500 hover:scale-105 cursor-pointer flex flex-col items-center justify-center text-center">
      <div className="mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500">
        <img src="/assets/image/Avtivity.png" alt="Activity Insights" className="w-24 h-24 object-contain" />
      </div>
